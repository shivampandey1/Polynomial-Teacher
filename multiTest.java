...
//imported libraries
public class multiTest extends JFrame implements ActionListener{
...
//gui design
    ...
    super ("Multiplication Test"); //question1 @ top
    
    frame = getContentPane (); //actualbox
    frame.setLayout(null);//default layout
    
     try {
                     FileReader fileR = new FileReader ("multiQuestions.txt");
                     BufferedReader input = new BufferedReader(fileR);
                        
                     FileReader fileR1 = new FileReader ("multiOption1.txt");
                     BufferedReader input1 = new BufferedReader(fileR1);
                     //pulls arrays from files listed
   ...
   random2 = (int)(Math.random() * 10 + 0);
    question2 = new JLabel (questions[random2]);//each instance of this code chooses a random value from the question array to be in the test
    answerlbl2 = new JLabel (" ");

   random3 = (int)(Math.random() * 10 + 0);
    question3 = new JLabel (questions[random3]);
...
//explains what to do if button pressed
    ...
    public static void main(String[] args) {
        ...
        multiTest launcher = new multiTest ();
    }//launcher
