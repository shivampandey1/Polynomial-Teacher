...
public class subtractionTest extends JFrame implements ActionListener{
...
//gui design
    ...
    frame.setLayout(null);//default layout
     ...
     try {
                     FileReader fileR = new FileReader ("subtractionQuestions.txt");
                     BufferedReader input = new BufferedReader(fileR);
                        
                     FileReader fileR1 = new FileReader ("subtractionOption1.txt");
...
//explains what to do if button pressed
    ...
    public static void main(String[] args) {
        ...
        subtractionTest launcher = new subtractionTest ();
    }//launcher
